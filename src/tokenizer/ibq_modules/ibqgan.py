...
from .vqvae.quantize import IndexPropagationQuantize
from .scheduler.lr_scheduler import Scheduler_LinearWarmup, Scheduler_LinearWarmup_CosineDecay
from .ema import LitEma
# from .ibq_modules.losses.vqperceptua import VQLPIPSWithDiscriminator
...
def load_vq_gan(args):
    model = IBQ(**args.model.init_args)
