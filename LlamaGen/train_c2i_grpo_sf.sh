...
srun torchrun \
    ...
    --master_port=12347 \
    autoregressive/train/train_c2i_grpo_sf.py \
    ...
    --aux-ce-weight 0.05 \
    --use-wandb --wandb-project autoreg-grpo --wandb-entity ${WANDB_ENTITY:-none} --wandb-run-name "c2i-grpo-sf" \
    "$@"