...
srun torchrun \
    ...
    --master_port=12346 \
    autoregressive/sample/sample_c2i_six_tf.py \
    --vq-ckpt $VQ_MODEL_PATH \
    --gpt-ckpt $GPT_MODEL_PATH --gpt-model GPT-XXL --from-fsdp \
    --hf-train-dir $DATA_PATH \
    --num-samples 8 \
    --top-k 0 --top-p 1.0 \
    --output-dir /mnt/petrelfs/huangsiyuan2/six_tf_plus_raw_mse \
